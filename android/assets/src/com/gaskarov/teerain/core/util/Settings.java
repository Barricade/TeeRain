...
public final class Settings {
	...
	public static final int REGION_SIZE_LOG = 4;
	public static final int REGION_SIZE = 1 << REGION_SIZE_LOG;
	public static final int REGION_SIZE_MASK = REGION_SIZE - 1;
	public static final int REGION_SQUARE_LOG = REGION_SIZE_LOG << 1;
	public static final int REGION_SQUARE = 1 << REGION_SQUARE_LOG;
	public static final int REGION_SQUARE_MASK = REGION_SQUARE - 1;
	public static final int REGION_PRELOAD_SIZE = 2;
	public static final int REGION_SOFT_SIZE = 4;
	...
	public static final int MAGIC_LAMP_LIGHT_SOURCE_ID = 9;
