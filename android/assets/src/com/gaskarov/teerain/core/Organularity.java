...
public final class Organularity implements ContactListener {
	...
	private OperationSolver mDataOperationSolver;
	...
	public static Organularity obtain() {
		...
		obj.mDataOperationSolver = new OperationSolver(1);
	...
	public static void recycle(Organularity pObj) {
		...
		pObj.mDataOperationSolver.dispose();
		pObj.mDataOperationSolver = null;
	...
	public boolean pushDataOperation(Runnable pRunnable) {
		return mDataOperationSolver.pushOperation(pRunnable);
	}

	public boolean removeDataOperation(Runnable pRunnable) {
		return mDataOperationSolver.removeOperation(pRunnable);
	}
