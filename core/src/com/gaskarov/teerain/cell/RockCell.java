 ...
 */
public final class RockCell extends Cell {
	...
	public static final float TILE_N_Y = Settings.TILE_H * 1;
	public static final float TILE_S_X = Settings.TILE_W * 1;
	public static final float TILE_S_Y = Settings.TILE_H * 1;
	public static final float TILE_H_X = Settings.TILE_W * 2;
	public static final float TILE_H_Y = Settings.TILE_H * 1;
	public static final float TILE_V_X = Settings.TILE_W * 3;
	public static final float TILE_V_Y = Settings.TILE_H * 1;
	public static final float TILE_B_X = Settings.TILE_W * 4;
	public static final float TILE_B_Y = Settings.TILE_H * 1;
	public static final boolean TILE_N_TR = false;
	public static final boolean TILE_S_TR = false;
	public static final boolean TILE_H_TR = false;
	public static final boolean TILE_V_TR = false;
	public static final boolean TILE_B_TR = false;
	...
	public boolean isTileConnected(Cellularity pCellularity, int pX, int pY, int pZ, Cell pCell,
			int pVX, int pVY) {
		return pCell instanceof RockCell;
	}
	...
	private static RockCell obtainPure() {
		if (GlobalConstants.POOL)
			synchronized (RockCell.class) {
				return sPool.size() == 0 ? new RockCell() : (RockCell) sPool.pop();
			}
		return new RockCell();
	}

	private static void recyclePure(RockCell pObj) {
		if (GlobalConstants.POOL)
			synchronized (RockCell.class) {
				sPool.push(pObj);
			}
	...
	public static RockCell obtain() {
		RockCell obj = obtainPure();
		obj.mPhysicsWallOrganoid = PhysicsWallOrganoid.obtain();
		obj.mTilesConnectedMask = 0;
		return obj;
	}

	public static void recycle(RockCell pObj) {
